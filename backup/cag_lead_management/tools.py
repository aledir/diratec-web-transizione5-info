"""Tool functions per il plugin CAG Lead Management."""
...
def save_lead_data(azienda=None, dimensione=None, settore=None, regione=None,
    ...
    """
    log.info(f"🔄 Tool save_lead_data chiamato (CAG Lead Management)")
...
def create_lead(session_id=None, cat=None):
    ...
    Returns:
        Dict: Risultato dell'operazione
    """
    log.info(f"🔄 Tool create_lead chiamato (CAG Lead Management)")
